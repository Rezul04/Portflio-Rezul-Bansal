    ...
    <footer className="relative z-10 overflow-x-clip">
      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col items-center gap-8 md:flex-row md:justify-between">
          <div className="text-white/40">Rezul Bansal</div>

          <nav className="flex flex-col md:flex-row items-center gap-8 z-50">
            <a href="https://github.com/Rezul04" className="inline-flex items-center gap-1.5 cursor-pointer" target="_blank">
              <span className="font-semibold">Github</span>
              <ArrowUpRightIcon className="size-4" />
            </a>
            <a href="https://www.instagram.com/i_.r.e.z.u.l__/" className="inline-flex items-center gap-1.5 cursor-pointer" target="_blank">
              <span className="font-semibold">Instagram</span>
              <ArrowUpRightIcon className="size-4" />
            </a>
            <a href="https://leetcode.com/u/rezul1212/" className="inline-flex items-center gap-1.5 cursor-pointer" target="_blank">
